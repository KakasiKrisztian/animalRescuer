...
public class Rescuer {
    ...
    public void play(RecreationalActivity recreationalActivity, Animal animal) {
        System.out.println(getName() + " is " + recreationalActivity.getName() + " with " + animal.getName() + ".");


        if (recreationalActivity.getName().equals(animal.getActivityPreferred())) {
            System.out.println(animal.getName() + " mood level is " + animal.getMoodLevel() + "/10");
